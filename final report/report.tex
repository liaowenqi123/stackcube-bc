...
We modify the observation encoder component of the NoisePredictor to impose rotation invariance or equivariance. Variants No.~7--10 use the v1 training configuration (hidden=256, depth=4) for fair comparison. Additionally, we implement a stand-alone SE(2) model (No.~11) with a custom architecture:
